...
<div class="sl-mainpanel">
  ...
  <div class="sl-pagebody">
    <div class="card pd-20 pd-sm-40">
         <h6 class="card-body-title">Modification
...
?>
         ...
         <form method="post" action="{{url('gestion/reunion/validerpv/'.$modifier->id)}}">
           @csrf
         <div class="form-layout">
           <div class="row mg-b-25">
             <div class="col-lg-4 col-sm-6">
               <input type="hidden" name="old_link" value="{{$modifier->link}}" >
               <select name="id_reunion">>
                 ...
                 ?>
                  <option value="{{$reu->id_reunion}}"
                    <?php if ($reu->id_reunion==$modifier->id_reunion){
                      echo "selected";
                    }
                    ?>>{{$dt}}</option>
                 @endforeach
             ...
             <div class="col-lg-12">
               <div class="form-group">
                 ...
                 <textarea class="form-control" name="link" id="summernote1">{!!$modifier->pv!!}</textarea>
               </div>
             </div><!-- col-4 -->

           <div class="form-layout-footer">
             <button class="btn btn-info mg-r-5">Enregistrer</button>
             <a href="{{route('liste.pv')}}" class="btn btn-secondary mg-r-5" style="float:right">Annuler</a>
